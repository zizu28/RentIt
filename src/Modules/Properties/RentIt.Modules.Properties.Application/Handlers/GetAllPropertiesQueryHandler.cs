...
internal sealed class GetAllPropertiesQueryHandler : IRequestHandler<Queries.GetAllPropertiesQuery, Result<IEnumerable<PropertyDto>>>
{
    ...
    public async Task<Result<IEnumerable<PropertyDto>>> Handle(Queries.GetAllPropertiesQuery request, CancellationToken cancellationToken)
    {
